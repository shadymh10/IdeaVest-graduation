# ============================================
# IAM Module - EKS + EC2 Roles & Policies
# ============================================
...
# ============================================
# EC2 Instance Role (Jenkins)
# Needs: EKS access, ECR pull, S3, CloudWatch
# ============================================
resource "aws_iam_role" "ec2_jenkins" {
  name = "${var.project_name}-${var.environment}-ec2-jenkins-role"
...
# Jenkins needs to interact with EKS
